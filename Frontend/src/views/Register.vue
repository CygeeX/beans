    ...
    <div class="auth-body">
      ...
      <div class="form-panel">
        <div class="card">
          ...
          <form @submit.prevent="handleRegister">
            ...
            <div class="field">
              ...
              <input
                ...
                required
              />
              <p v-if="confirmMismatch" class="field-error">两次密码不一致</p>
            </div>
          ...
          <p class="switch-tip">
            已有账号？
            <router-link to="/" class="switch-link">立即登录</router-link>
          </p>
        </div>
      </div>
...
.auth-page {
  ...
  --err-text:      #d4806a;
  --ok-bg:         rgba(60, 100, 48, 0.12);
  --ok-border:     rgba(60, 100, 48, 0.3);
  --ok-text:       #7ab870;
}
...
.input-error {
  border-color: rgba(192, 72, 48, 0.6) !important;
  box-shadow: 0 0 0 3px rgba(192, 72, 48, 0.12) !important;
}
